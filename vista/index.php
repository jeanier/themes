                ...
                <div class="panel-body" id="principal" >                                                                                                    
                    <form class="form-signin" id="formlogin">
                        ...
                        <div class="input-group" id="campo1">
                            ...
                            <input type="text" name="usu" id="itFolio" class="form-control form-login btn-block" placeholder="Usuario" autofocus autocomplete="off" />
                        </div>
                        <br>
                        ...
                        <div class="input-group" id="campo2">
                            ...
                            <input type="password" name="pwd" id="itPassword" class="form-control form-login btn-block" placeholder="Contraseña" autocomplete="new-password" />
                        </div>
                        <br>
