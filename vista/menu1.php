...
<body>
    <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="#">DooSystem</a> 
            </div>
            <div class="row-fluid">
                <div class="row" style="float: left; margin: 0 0 0 25px;" >
                    <p style="color: #3DC7BE;"><?php $hoy = date("Y-m-d "); echo $hoy; echo $_SESSION['nombre']; ?></p>
                </div>
                <div class="row" style="float: right; margin: 12px 25px 0 0;">
                    <a href="#" class="btn btn-primary"" style="width: 100px;" onclick="logOut()">Salir</a>
                </div>                
            </div>          
        </nav>   
        <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                      ...
                      <li>
                        <a  href="#" onclick="loadCustomers()"><i class="fa fa-desktop fa-2x"></i> Clientes</a>
                    </li>
                    <li>
                        <a  href="#" onclick="loadPagos()"><i class="fa fa-qrcode fa-2x"></i> Pagos</a>
                    </li>
                    <li  >
                        <a  href="#" onclick="loadLicencias()"><i class="fa fa-bar-chart-o fa-2x"></i> Licencias</a>
                    </li>   
                      <li  >
            ...
            <div id="page-wrapper" >
                <div id="page-inner">
                    <div class="row-fluid" id="contenido">
                        <div class="col-md-12">
                         <h2>DooSystem</h2>   
                         <h5>Welcome, contentos que estes aquí!. </h5>
