...
class usuarioBo {
    ...
    function registrarUsuarioBo($apaterno, $amaterno, $nombre, $usuario,$email, $password, $tipo, $status) {
        $resultado = $this->dao->registrarUsuarioDao($apaterno, $amaterno, $nombre, $usuario, $email, $password, $tipo, $status);
        return $resultado;
    }
    ...
    function saveDataUsuarioBo($id, $apaterno, $amaterno, $nombre, $usuario, $email, $password, $tipo, $status) {
        $resultado = $this->dao->saveDataUsuarioDao($id, $apaterno, $amaterno, $nombre, $usuario, $email, $password, $tipo, $status);
        return $resultado;
    }
